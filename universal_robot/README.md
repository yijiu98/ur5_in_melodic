...
# xia xiaowu -------------------------------
#real robot
launch yi jian qi dong: roslaunch ur_planning start_ur5.launch
-------------------------------
roslaunch ur_modern_driver ur5_bringup.launch
roslaunch ur5_moveit_config ur5_moveit_planning_execution.launch  (include rosrun urplanning moveitServer.py)
...
rosrun urlanning moveitServer.py
...
roslaunch ur_bringup ur5_bringup.launch limited:=true robot_ip:=192.168.50.100
roslaunch ur_modern_driver ur5_ros_control.launch limited:=true robot_ip:=192.168.50.100
